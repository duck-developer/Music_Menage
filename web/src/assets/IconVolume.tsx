...
const IconVolume= ({ className, width = 24, height = 24, color = 'black' }: IconVolumeProps) => {
    return (
        <svg
            className={className}
            viewBox="0 0 16 16"
...
// ""></path><path d="M11.5 13.614a5.752 5.752 0 0 0 0-11.228v1.55a4.252 4.252 0 0 1 0 8.127v1.55z"></path></svg> */}